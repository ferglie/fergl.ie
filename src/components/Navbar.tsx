    ...
    <nav className="text-xl">
      <div className="flex justify-center space-x-4">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex items-center px-3 py-2 font-medium text-gray-300 rounded-md hover:bg-gray-700 hover:text-white"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="px-3 py-2 font-medium text-gray-300 rounded-md hover:bg-gray-700 hover:text-white"
        >
